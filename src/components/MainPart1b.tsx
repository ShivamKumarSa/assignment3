        ...
        <Box sx={{width:'100%',height:'85%',backgroundColor:'white',borderRadius:'10px ',boxSizing:'border-box',padding:'1.5rem 2rem'}}>
            <Box sx={{display:'flex',justifyContent:'space-between',height:'100%',width:'100%'}}>
                ...
                <Box sx={{flex:'2',display:'flex'}}>
                    <Box sx={{height:'100%',width:'5rem',zIndex:'1',borderTop: '1px solid #F5F5F5',borderBottom: '1px solid #F5F5F5',position: 'relative' }}> 
                        <Box sx={{margin:'0 10%',width:'10%',height:'99%',borderRadius:'5px',backgroundColor:'#F6F6FA',display:'inline-block',position:'relative'}}> 
                    ...
                    <Box sx={{flex:'1',height:'100%',display:'flex',flexDirection:'column',justifyContent:'space-between',marginLeft:'0.5rem'}}>
